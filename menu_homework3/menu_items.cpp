...
const Swd2k::MenuItem Swd2k::SHOW_VLADIVOSTOK_MENU = {
    "1 - Хочу узнать про Владивосток!",  // title
    Swd2k::show_vladivostok_menu,        // func
    &Swd2k::SHOW_DALNIY_VOSTOK_MENU,     // parent
    nullptr,                             // children
    0                                    // children_count
};

const Swd2k::MenuItem Swd2k::SHOW_SAKHALIN_MENU = {
    "2 - Хочу узнать про Сахалин!",
...
const Swd2k::MenuItem Swd2k::SHOW_DALNIY_VOSTOK_MENU = {
    "1 - Хочу узнать про Дальний Восток!",
    Swd2k::show_dalniy_vostok_menu,
    &Swd2k::STUDY,
    dalniy_vostok_children,
    dalniy_vostok_size
};

const Swd2k::MenuItem Swd2k::SHOW_ALTAY_MENU = {
    "2 - Хочу узнать про Алтай!",
...
const Swd2k::MenuItem Swd2k::SHOW_ZOLOTOE_KOLTSO_ROSSII_MENU = {
    "3 - Хочу узнать про Золотое Кольцо России!",
...
const Swd2k::MenuItem Swd2k::MAIN = {
    nullptr,        // title
    Swd2k::show_menu, // func
    nullptr,        // parent
    main_children,  // children
    main_size       // children_count
};
